...
import com.mayh.star.adapter.GuideViewPagerAdapter;
...
public class WelcomeGuideActivity extends BaseActivity implements View.OnClickListener {
    ...
    // 引导页图片资源
    private static final int[] pics = { R.layout.welcome_guide_one_layout,
            R.layout.welcome_guide_two_layout, R.layout.welcome_guide_three_layout, R.layout.welcome_guide_four_layout };
